				...
				<form class="form-horizontal" role="form" id="setting-form" action="<?php echo Main::ahref("settings") ?>" method="post" enctype="multipart/form-data">
					...
					<div id="ads" class="tabbed">
					    ...
					    <div class="col-sm-9">
					      ...
					      <div class="help-block">You can display this ad in any of the theme files by using this code: <strong><?php echo htmlentities('<?php echo $this->ads(728) ?>') ?></strong></div>
					    </div>
					  </div>				
						<div class="form-group">
					    ...
					    <div class="col-sm-9">
					      ...
					      <div class="help-block">You can display this ad in any of the theme files by using this code: <strong><?php echo htmlentities('<?php echo $this->ads(468) ?>') ?></strong></div>
					    </div>
					  </div>				
						<div class="form-group">
					    ...
					    <div class="col-sm-9">
					      ...
					      <div class="help-block">You can display this ad in any of the theme files by using this code: <strong><?php echo htmlentities('<?php echo $this->ads(300) ?>') ?></strong></div>
					    </div>
					  </div>							
					</div><!-- /#ads.tabbed -->			
